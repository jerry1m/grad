...
#test_size = 0.2
postfix = 'jpg'
imgpath = r'train/images/'
txtpath = r'train/labels/'



# output_train_img_folder = r'datasets/images/train'
# output_val_img_folder = r'datasets/images/val'
# output_train_txt_folder = r'datasets/labels/train'
# output_val_txt_folder = r'datasets/labels/val'

output_train_img_folder = r'datasets/train/images'
output_val_img_folder = r'datasets/val/images'
output_train_txt_folder = r'datasets/train/labels'
output_val_txt_folder = r'datasets/val/labels'
